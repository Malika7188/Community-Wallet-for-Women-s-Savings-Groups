...
const Sidebar: React.FC<SidebarProps> = ({ isCollapsed, setIsCollapsed }) => {
  ...
  {!isCollapsed && <span className="text-2xl font-bold text-white tracking-wide">Chama Trust Wallet</span>}
  ...
  {!isCollapsed && <span className="text-xs text-gray-300">Secured by Chama Trust Wallet</span>}
      </div>
    </aside>
  );
};
